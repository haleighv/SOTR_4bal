...
#define SSEG_DP_0_val   0   //- digit1 DP
#define SSEG_DP_1_val   1   //- digit2 DP
#define SSEG_DP_2_val   2   //- digit3 DP
#define SSEG_DP_3_val   3  //- digit4 DP
#define SSEG_DP_4_val   4  //- colon between digits two and three
#define SSEG_DP_5_val   5   //- digit3 degree
